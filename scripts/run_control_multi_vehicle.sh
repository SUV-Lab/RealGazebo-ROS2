#!/bin/bash
# Keyboard control demo for multiple vehicles.
...
docker exec -it -u user "$CONTAINER" bash -c "source /opt/ros/jazzy/setup.bash && source /home/user/realgazebo/RealGazebo-ROS2/install/setup.bash && ros2 launch realgazebo control_multi_vehicle.launch.py"
